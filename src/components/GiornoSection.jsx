        ...
        <div className="space-y-6">
            <div className="flex justify-between items-start border-b border-emerald-500/30 pb-3">
                <div className="flex-1">
                    ...
                    <p className="text-emerald-400/80 text-xs font-bold uppercase italic mb-2">
            ...
            {showDettagli && giorno.descrizione_completa && (
                <div className="bg-emerald-950/20 border-l-2 border-emerald-500 p-4 rounded-r-lg animate-in fade-in slide-in-from-top-2">
                    <h4 className="text-[10px] font-black text-emerald-500 uppercase mb-2">Dettagli Plot / Note Master</h4>
                    <div className="text-gray-300 text-sm whitespace-pre-wrap italic">
                        {giorno.descrizione_completa}
                    </div>
                </div>
            )}
